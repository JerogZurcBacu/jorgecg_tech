        ...
        return (
            <div className="contenedor-links">
                <div className="sub-contenedpr-links">
                    ...
                    <h3 className="titulo-link"><a href="https://www.freecodecamp.org/JerogZurcG" target="_blank">Free Code Camp</a></h3>
                ...
                <div className="sub-contenedpr-links">
                    ...
                    <h3 className="titulo-link"><a href="https://capacitateparaelempleo.org/" target="_blank">Dip. Técnico Superior en Big Data</a></h3>
                ...
                <div className="sub-contenedpr-links">
                    ...
                    <h3 className="titulo-link"><a href="https://ceneval.edu.mx/examenes-ingreso-exani_i/" target="_blank">Bachillerato Completo</a></h3>
